...
$ python3 A3S.py <port> [secretkey]
E.g. $ python3 A3S.py 4444 password

On the Client side you run the code as follows:
$ python3 A3C.py <command> <filename> <hostname:port> <cipher> [key]
E.g. $ python3 A3C.py write 1MB.bin 136.157.19.23:4444 aes128 pass1234 < 1MB.bin
E.g. $ python3 A3C.py read 1GB.bin 221.119.52.32:4523 aes256 password > 1GB.bin
